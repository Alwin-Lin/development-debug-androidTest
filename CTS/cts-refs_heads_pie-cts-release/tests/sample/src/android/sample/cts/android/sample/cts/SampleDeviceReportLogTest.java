 ...
 *
 * It could be ignored since there are no JUnit3 in this
 */
//@RunWith(AndroidJUnit4ClassRunner.class)
@RunWith(AndroidJUnit4ClassRunner.class)

/**
 * @LargeTest is ignorable in this case
 * more on this https://testing.googleblog.com/2010/12/test-sizes.html
 */
@LargeTest
public class SampleDeviceReportLogTest {
    @Rule
public  ActivityTestRule<SampleDeviceActivity> activityRule =
    ...
    public void countHelper(int testParameter, String streamName) {
        // Perform test.
        int start;
        int end;
        if (testParameter == 1) {
